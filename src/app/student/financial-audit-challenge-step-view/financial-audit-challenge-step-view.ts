...
import { FinancialAuditChallengeStep } from '../../core/models/module.model';
 ...
 * five-day habit grid plus a one-time structured reflection. Complete unlocks
 * only when every day is logged and every reflection line is filled; the
 * reflection is then submitted.
 */
@Component({
  selector: 'app-financial-audit-challenge-step-view',
  standalone: true,
  templateUrl: './financial-audit-challenge-step-view.html',
  styleUrl: './financial-audit-challenge-step-view.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FinancialAuditChallengeStepView implements OnInit {
  readonly step = input.required<FinancialAuditChallengeStep>();
