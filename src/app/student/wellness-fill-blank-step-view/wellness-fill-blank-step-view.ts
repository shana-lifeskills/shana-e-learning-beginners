...
import { WellnessFillBlankSentence, WellnessFillBlankStep } from '../../core/models/module.model';

/**
 * "Fill in the Blank" game (Wellness Module, Week 4). Tap a word from the bank
 ...
 * once every blank is filled. Its own visual design — see `WellnessFillBlankStep`
 * in `module.model.ts`.
 */
@Component({
  selector: 'app-wellness-fill-blank-step-view',
  standalone: true,
  templateUrl: './wellness-fill-blank-step-view.html',
  styleUrl: './wellness-fill-blank-step-view.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WellnessFillBlankStepView implements OnInit {
  readonly step = input.required<WellnessFillBlankStep>();
  ...
  isFilled(sentence: WellnessFillBlankSentence): boolean {
  ...
  placeInBlank(sentence: WellnessFillBlankSentence): void {
